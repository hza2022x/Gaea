...
// MockedConnectionPool is an autogenerated mock type for the MockedConnectionPool type
type MockedConnectionPool struct {
	mock.Mock
}

// Active provides a mock function with given fields:
func (_m *MockedConnectionPool) Active() int64 {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) Addr() string {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) Available() int64 {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) Capacity() int64 {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) Close() {
	_m.Called()
}

// Get provides a mock function with given fields: ctx
func (_m *MockedConnectionPool) Get(ctx context.Context) (backend.PooledConnect, error) {
	ret := _m.Called(ctx)
...
func (_m *MockedConnectionPool) IdleClosed() int64 {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) IdleTimeout() time.Duration {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) InUse() int64 {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) MaxCap() int64 {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) Open() {
	_m.Called()
}

// Put provides a mock function with given fields: pc
func (_m *MockedConnectionPool) Put(pc backend.PooledConnect) {
	_m.Called(pc)
}

// SetCapacity provides a mock function with given fields: capacity
func (_m *MockedConnectionPool) SetCapacity(capacity int) error {
...
func (_m *MockedConnectionPool) SetIdleTimeout(idleTimeout time.Duration) {
	_m.Called(idleTimeout)
}

// StatsJSON provides a mock function with given fields:
func (_m *MockedConnectionPool) StatsJSON() string {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) WaitCount() int64 {
	ret := _m.Called()
...
func (_m *MockedConnectionPool) WaitTime() time.Duration {
	ret := _m.Called()
